    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    ViewBag.errorMessage = "Musisz potwierdzić swoj email aby się zalogować.";
                    return View("Error");
                }
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model , HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Potwierdź swoją tożsamość przed pierwszym zalogowaniem klikając <a href=\"" + callbackUrl + "\">tutaj</a>");
                    await this.UserManager.AddToRoleAsync(user.Id, "User");

                    ViewBag.Message = "Sprawdź swój adres email. Przed pierwszym zalogowaniem wymagane jest potwierdzenie twojej tożsamości.";
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Reset Password", "Aby dokończyć proces zresetowania hasła kliknij <a href=\"" + callbackUrl + "\">tutaj</a>");
